...
Invasion.Play.prototype = {
    create:function(){
        ...
        this.clouds = this.add.sprite (this.world.centerX, this.world.centerY-40, "clouds");
        this.clouds.anchor.setTo(.5);
        this.physics.enable(this.clouds);
        this.clouds.visible = false;
        this.clouds.body.immovable = true;
        this.clouds.body.checkCollision.up = false;
    ...
    update:function(){
        ...
        this.game.physics.arcade.collide(this.ship, this.clouds);
        // movimentos
